;メッセージレイヤの定義
		...
		[position width=640 height=200 top=780 left=0 ]


		
			[position page=fore margint=45 marginl=10 marginr=20 marginb=20 vertical=false opacity="0" radius="0" color="0x000000" ]
		...
		;クリック待ちボタンについて
		[glyph fix="true" left="700" top="1000" line="nextpage.gif" anim="" ]
		...
		[position layer="message1" width=640 height=200 top=780 left=0 ]
